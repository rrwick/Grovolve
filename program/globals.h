...
enum GraphData {POPULATION,
                TALLEST_PLANT, NINETY_NINTH_PERCENTILE_PLANT_HEIGHT, NINETIETH_PERCENTILE_PLANT_HEIGHT, MEDIAN_PLANT_HEIGHT,
                HEAVIEST_PLANT, NINETY_NINTH_PERCENTILE_PLANT_MASS, NINETIETH_PERCENTILE_PLANT_MASS, MEDIAN_PLANT_MASS,
                MOST_PLANT_ENERGY, NINETY_NINTH_PERCENTILE_PLANT_ENERGY, NINETIETH_PERCENTILE_PLANT_ENERGY, MEDIAN_PLANT_ENERGY,
                SEED_COUNT, ENERGY_PER_SEED,
                MEAN_DEATH_AGE, MEAN_STARVATION_DEATH_AGE, MEAN_NON_STARVATION_DEATH_AGE};
